              ...
              <div className="header-section">
                <div className="navbar navbar-">
                  ...
                  <a href="#" className="logo-link">
                    <img className="logo" src="../assets/images/logos/logo-4.png" alt="logo">
                  </a>
                    ...
                    <div className="offcanvas-body">
                      ...
                      <ul className="navbar-nav">
                        ...
                        <li className="nav-item dropdown dropdown-mega">
                          ...
                          <div className="dropdown-menu home-menu">
                            <div className="row g-4">
                              <div className="col-xl-2 mega-box">
                                <a className="home-box" href="index.html">
                                  <img className="img-fluid" src="../assets/images/demo-img/demo1.jpg" alt="home1">
                                  <span>Fashion Demo</span>
                                </a>
                              </div>

                              <div className="col-xl-2 mega-box">
                                <a className="home-box" href="index-2.html">
                                  <img className="img-fluid" src="../assets/images/demo-img/demo2.jpg" alt="home2">
                                  <span>Bag Demo</span>
                                </a>
                              </div>

                              <div className="col-xl-2 mega-box">
                                <a className="home-box" href="index-3.html">
                                  <img className="img-fluid" src="../assets/images/demo-img/demo3.jpg" alt="home3">
                                  <span>Grocery Demo</span>
                                </a>
                              </div>

                              <div className="col-xl-2 mega-box">
                                <a className="home-box" href="index-4.html">
                                  <img className="img-fluid" src="../assets/images/demo-img/demo4.jpg" alt="home4">
                                  <span>Furniture Demo</span>
                                </a>
                              </div>

                              <div className="col-xl-2 mega-box">
                                <a className="home-box" href="index-5.html">
                                  <img className="img-fluid" src="../assets/images/demo-img/demo5.jpg" alt="home5">
                                  <span>Watch Demo</span>
                                </a>
                              </div>

                              <div className="col-xl-2 mega-box">
                                <a className="home-box" href="index-6.html">
                                  <img className="img-fluid" src="../assets/images/demo-img/demo6.jpg" alt="home6">
                        ...
                        <li className="nav-item dropdown">
                          ...
                          <div className="dropdown-menu">
                            <div className="dropdown-column">
                              <a className="dropdown-item" href="shop-categories.html">Shop Categories</a>
                              <a className="dropdown-item" href="shop-filter.html">Shop Filter</a>
                              ...
                              <a className="dropdown-item" href="shop-masanory.html">Shop Masonry</a>
                              <a className="dropdown-item" href="shop-no-sidebar.html">Shop No Sidebar</a>
                              <a className="dropdown-item" href="shop-right-sidebar.html">Shop Right Sidebar</a>
                              <a className="dropdown-item" href="shop-top-filter.html">Shop Top Filter</a>
                            </div>
                          </div>
                        </li>
                        ...
                        <li className="nav-item dropdown">
                          ...
                          <div className="dropdown-menu">
                            <div className="dropdown-column">
                              <a className="dropdown-item" href="product-four-image.html">Product 4 Images</a>
                              <a className="dropdown-item" href="product-slider.html">Product Slider </a>
                              <a className="dropdown-item" href="product-sticky.html">Product Sticky</a>
                              <a className="dropdown-item" href="product-three-column.html">Product 3 Column</a>
                              <a className="dropdown-item" href="product-video-img.html">Product Video</a>
                              <a className="dropdown-item" href="product.html">Product Simple</a>
                            </div>
                          </div>
                        </li>
                        ...
                        <li className="nav-item dropdown">
                          ...
                          <div className="dropdown-menu">
                            <div className="dropdown-column">
                              ...
                              <a className="dropdown-item" href="faqs.html">Faqs</a>
                              <a className="dropdown-item" href="forgot-password.html">Forgot Password</a>
                              <a className="dropdown-item" href="login.html">Login</a>
                              <a className="dropdown-item" href="order-success.html">Order Success</a>
